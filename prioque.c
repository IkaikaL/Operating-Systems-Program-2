...
void destroy_queue(Queue *q) {
  // pthread_mutex_lock: Locks a mutex object, which identifies a mutex. 
  // If the mutex is already locked by another thread, 
  // the thread waits for the mutex to become available. 
  ...
  // pthread_mutex_unlock() causes one of those threads to return from pthread_mutex_lock() 
  // with the mutex object acquired. 
